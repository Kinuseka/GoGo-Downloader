...
name='GoGoDownloader(v1.3p3)'

zipname='GoGoDownloader.v1.3p3.zip'

link='https://github.com/Kinuseka/GoGo-Downloader/releases/download/V1.3-patch(3)/GoGoDownloader.v1.3p3.zip'
