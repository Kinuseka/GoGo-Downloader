...
name='GoGoDownloader(v1.3p7)'

zipname='GoGoDownloader.v1.3p7.zip'

link='https://github.com/Kinuseka/GoGo-Downloader/releases/download/V1.3-patch(7)/GoGoDownloader.v1.3p7.zip'
