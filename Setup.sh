...
name='GoGoDownloader(v1.3p2)'

zipname='GoGoDownloader.v1.3p2.zip'

link='https://github.com/Kinuseka/GoGo-Downloader/releases/download/V1.3-patch(2)/GoGoDownloader.v1.3p2.zip'
